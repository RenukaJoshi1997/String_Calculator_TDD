...
class StringCalculatorShould {
	...
	@Test
	void ignore_numbers_greater_than_1000() throws Exception {
		assertEquals(10, stringCalculator.add("10,1001"));
	}

	@Test
	void should_support_delimiter_of_any_length() throws Exception {
		assertEquals(6, stringCalculator.add("//[***]\n1***2***3"));
	}
	...
	@Test
	void should_support_multiple_delimiter_longer_length() throws Exception {
		assertEquals(6, stringCalculator.add("//[**][%%]\n1**2%%3"));
	}
}
